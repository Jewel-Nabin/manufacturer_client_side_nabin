...
const Newsletter = () => {
    return (
        <div className='text-center my-20 mx-5 bg-accent p-10'>
            ...
            <input type="text" placeholder="Type here" className="input input-bordered input-error w-full max-w-xs mt-2" />
            <br />
            <button className="btn btn-outline btn-secondary mt-2 text-white">Sign up</button>
        </div>
    );
};
